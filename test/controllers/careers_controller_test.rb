...
class CareersControllerTest < ActionController::TestCase
  ...
  test "should create career" do
    assert_difference('Career.count') do
      post :create, career: { amount: @career.amount, code: @career.code, name: @career.name, quantity_credits: @career.quantity_credits, semester: @career.semester }
    end
  ...
  test "should update career" do
    patch :update, id: @career, career: { amount: @career.amount, code: @career.code, name: @career.name, quantity_credits: @career.quantity_credits, semester: @career.semester }
    assert_redirected_to career_path(assigns(:career))
  end
