...
class ScoresControllerTest < ActionController::TestCase
  ...
  test "should create score" do
    assert_difference('Score.count') do
      post :create, score: { final: @score.final, partial_one: @score.partial_one, partial_two: @score.partial_two }
    end
  ...
  test "should update score" do
    patch :update, id: @score, score: { final: @score.final, partial_one: @score.partial_one, partial_two: @score.partial_two }
    assert_redirected_to score_path(assigns(:score))
  end
